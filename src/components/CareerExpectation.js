    ...
    return(
        ...
        <div className="standardSection">
            ...
            <div className="introBox">
                ...
                <p>CAREER EXPECTATION PAGE Lorem ipsum dolor sit amet, consectetur jjfjfjajlalalallaadip kdkjhdh
                ...
                <div className="readMoreBox">
                    <div className="read">
                        <NavLink exact to='/hobbies' className="readMore">Read More</NavLink>
                    </div>                    
                </div>
            </div> 
